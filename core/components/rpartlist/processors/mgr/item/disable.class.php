...
class RPartListItemDisableProcessor extends modObjectProcessor
{
    ...
    public function process()
    {
        ...
        foreach ($ids as $id) {
            ...
            if ($user_id) {
                ...
                $create_log->set('action', 'Снял с публикации => ' . '(' . $id . ') - ' . $object->get('name'));
...
return 'RPartListItemDisableProcessor';
