RPartList.grid.Brands = function (config) {
    config = config || {};
    if (!config.id) {
        config.id = 'rpartlist-grid-brands';
    }
    ...
    RPartList.grid.Brands.superclass.constructor.call(this, config);
...
Ext.extend(RPartList.grid.Brands, MODx.grid.Grid, {
    windows: {},
    ...
    createItem: function (btn, e) {
        var w = MODx.load({
            xtype: 'rpartlist-brand-window-create',
            id: Ext.id(),
            listeners: {
                success: {
                    fn: function () {
...
Ext.reg('rpartlist-grid-brands', RPartList.grid.Brands);
